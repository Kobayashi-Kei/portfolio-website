    ...
    <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
      ...
      <div class="flex flex-col justify-between xl:w-5/12">
        ...
        <div class="sm:text-center lg:py-12 lg:text-left xl:py-24">
          <p class="mb-4 font-semibold text-indigo-500 md:mb-6 md:text-lg xl:text-xl">Master's Program Student at the University of Electro-Communications, Software Engineer</p>
        ...
        <div class="mt-8 flex items-center justify-center gap-4 sm:mt-16 lg:justify-start">
          ...
          <div class="flex gap-4">
            <a href="https://github.com/Kobayashi-Kei" target="_blank" class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
